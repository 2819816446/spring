package com.ailen.springboot02.config;

import com.ailen.springboot02.mq.consumer.OrderListener;
import com.ailen.springboot02.mq.consumer.PayListener;
    ...
    public RabbitTemplate rabbitTemplate(){
        ...
        rabbitTemplate.setConfirmCallback(new RabbitTemplate.ConfirmCallback() {
            ...
            public void confirm(CorrelationData correlationData, boolean ack, String cause) {
                logger.info("消息发送到exchange成功:correlationData({}),ack({}),cause({})",correlationData,ack,cause);
            }
